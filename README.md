...
friends: [
    {
        title: "wuruiliang Blog",
        href: "https://wuruiliang.github.io/"
    },
    {
        title: "Apple",
...
ga_domain: wuruiliang.me			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“wuruiliang Blog”** 但是我想要在搜索的时候显示 **“吴瑞梁的博客 | wuruiliang Blog”** ，这个就需要 SEO Title 来定义了。
